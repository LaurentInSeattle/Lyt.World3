...
#pragma warning restore 8618
    ...
    {
        this.CurrentSector = "Agriculture";

        // Loop 1: Food from Investment in Land Development
        this.CurrentSubSector = "Food from Investment in Land Development";
        ...
        this.CurrentSubSector = "Food from Investment in Agricultural Inputs";
        ...
        this.CurrentSubSector = "Agricultural Investment Allocation Decision";
        ...
        this.CurrentSubSector = "Land Erosion and Urban-Industrial Use";
        ...
        this.CurrentSubSector = "Land Fertility";
        ...
        this.CurrentSubSector = "Land Maintenance";

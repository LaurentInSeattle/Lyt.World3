        ...
        new PlotDefinition(
            ...
            [
                new ("industrialCapital", "Industrial Capital",
                    HasAxis: true, AxisName: "Capital", ScaleFactor: 1e-12, 
                    ScaleUsingAxisIndex:0, CurveFormatter : CurveFormatter.FloatOne),
                new ("serviceCapital", "Service Capital", ScaleFactor: 1e-12,
                    HasAxis: false, ScaleUsingAxisIndex:0, CurveFormatter: CurveFormatter.FloatOne),
                new ("jobs", "Jobs",
                    HasAxis: true, ScaleUsingAxisIndex:1, CurveFormatter : CurveFormatter.Population),
                new ("laborUtilizationFraction", "Employment",
                    HasAxis: true, AxisName: "Percentage",
                    ScaleUsingAxisIndex:2, CurveFormatter : CurveFormatter.Percentage),
                new ("nonrenewableResourceFractionRemaining", "Resources Left",
